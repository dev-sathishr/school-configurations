...
export class EmployeeGroupListComponent {
  ...
  readonly apiUrl = API.employeeGroups.base;
  readonly deleteUrl = API.employeeGroups.deleteMultiple;

  readonly columns: ColumnConfig[] = [
    { key: 'name', label: 'Name', sortable: true, searchable: true },
    { key: 'employee_category_name', label: 'Employee Category', sortable: true, searchable: true },
