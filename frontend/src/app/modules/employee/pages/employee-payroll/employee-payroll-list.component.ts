              ...
              <div class="mb-3 flex items-start justify-between gap-3">
                <div class="flex items-center gap-2">
                  ...
                  <span class="text-foreground text-xs font-semibold">
                    ...
                    @if (p.relieving_date) { — {{ p.relieving_date | date:'dd MMM yyyy' }} }
                    @else { — Present }
                  </span>
                </div>
              ...
              <div class="grid grid-cols-2 gap-x-6 gap-y-1.5 md:grid-cols-4">
                ...
                @if (p.basic_salary) {
                  <div>
                    ...
                    <p class="text-foreground text-xs font-medium">₹ {{ p.basic_salary | number:'1.0-0' }}</p>
                  </div>
                }
                @if (p.day_wages) {
                  <div>
                    <p class="text-muted-foreground text-[10px] uppercase tracking-wide">Day Wages</p>
                    <p class="text-foreground text-xs font-medium">₹ {{ p.day_wages | number:'1.0-0' }}</p>
                  </div>
                }
                @if (p.biometric_id) {
                  <div>
