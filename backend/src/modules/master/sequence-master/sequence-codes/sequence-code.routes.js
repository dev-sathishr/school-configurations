...
router.get('/:id', checkRecordOwnership('settings.sequence_codes', 'SEQUENCE_CODES'), getById);
...
router.put('/:id', authorizeModule('SEQUENCE_CODES', 'EDIT'), checkRecordOwnership('settings.sequence_codes', 'SEQUENCE_CODES'), update);
router.delete('/:id', authorizeModule('SEQUENCE_CODES', 'DELETE'), checkRecordOwnership('settings.sequence_codes', 'SEQUENCE_CODES'), remove);
