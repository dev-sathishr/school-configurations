...
router.get('/:id',              checkRecordOwnership('settings.fee_categories', 'FEE_CATEGORIES'), getById);
...
router.put('/:id',              authorizeModule('FEE_CATEGORIES', 'EDIT'),   checkRecordOwnership('settings.fee_categories', 'FEE_CATEGORIES'), update);
router.delete('/:id',          authorizeModule('FEE_CATEGORIES', 'DELETE'), checkRecordOwnership('settings.fee_categories', 'FEE_CATEGORIES'), remove);
