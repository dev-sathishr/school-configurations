...
const SELECT_FIELDS = `u.id, u.username, u.full_name, u.email, u.phone, u.role, u.is_active,
...
const JOINS = 'LEFT JOIN settings.users cb ON u.created_by = cb.id LEFT JOIN settings.users ub ON u.updated_by = ub.id';
...
async function create(data, userId) {
  ...
  `, [
    ...
    data.role || 'clerk', data.is_active !== undefined ? data.is_active : true,
    userId, userId,
  ]);
