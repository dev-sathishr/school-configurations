...
async function seed() {
  ...
  try {
    ...
    const modules = [
      ...
      { key: 'ENGINE_META',   name: 'DocType Manager', display_name: 'ENGINE_META',     icon: 'assets/icons/heroicons/outline/table-cells.svg',        route_path: '/engine/meta',            display_order: 1, enforce_edit_lock: false, description: 'Define custom DocTypes and their fields' },
    ];
